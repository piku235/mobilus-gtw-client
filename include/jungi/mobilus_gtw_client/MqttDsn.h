...
public:
    ...
    MqttDsn(std::string host, std::optional<uint16_t> port, std::optional<std::string> username, std::optional<std::string> password, bool secure, std::optional<std::string> caFile);
    ...
    const std::optional<std::string>& caFile() const { return mCaFile; }
...
private:
    ...
    bool mSecure;
    std::optional<std::string> mCaFile;
};
